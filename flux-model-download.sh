...
[ ! -d "/workspace/ComfyUI/models/unet" ] && mkdir -p /workspace/ComfyUI/models/unet
[ ! -d "/workspace/ComfyUI/models/vae" ] && mkdir -p /workspace/ComfyUI/models/vae
[ ! -d "/workspace/ComfyUI/models/clip" ] && mkdir -p /workspace/ComfyUI/models/clip
[ ! -d "/workspace/ComfyUI/models/controlnet" ] && mkdir -p /workspace/ComfyUI/models/controlnet

# Print completion message
echo "Downloading approx 20 GB. Please wait."
...
wget -p /workspace/ComfyUI/models/controlnet https://huggingface.co/Kijai/flux-fp8/resolve/main/flux_shakker_labs_union_pro-fp8_e4m3fn.safetensors
